...
CPxplorer is a workflow for targeted mass spectrometric batch analysis
and rapid quantification of polychlorinated alkanes (PCAs) and related
analogues. The workflow includes three modules:  
...
devtools::install_github() function while the server versions might not
